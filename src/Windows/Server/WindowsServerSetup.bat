...
REM post-boot:
REM netsh interface ip set address name="Ethernet" static 192.168.151.54 255.255.255.0 192.168.151.49
REM netsh interface ipv4 set interface 5 dadtransmits=0 store=persistent