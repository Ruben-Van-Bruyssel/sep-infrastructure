@echo off
REM -------------------------------
REM Windows 10 Client VirtualBox Installatie
REM -------------------------------
...
SET DOMAIN_NAME=i3-syndus.internal
SET PRODUCT_KEY=GN9V4-2PF2V-8THYJ-V2JTF-844B3
SET VM_MEMORY= 2048
SET VM_CPUS= 1
...
REM -------------------------------
REM Configure Bridged Network Adapter
@echo Netwerkconfiguratie starten (Bridged Mode)
VBoxManage modifyvm "%VM_NAME%" --nic1 bridged --bridgeadapter1 "Cisco AnyConnect Secure Mobility Client Virtual Miniport Adapter for Windows x64"
@echo Netwerkconfiguratie voltooid
...
REM -------------------------------
REM Unattended installatie (Automatische Windows installatie)
@echo "%ISO_PATH%"
...
VBoxManage unattended install "%VM_NAME%" ^
    ...
    --key="%PRODUCT_KEY%" ^
    --start-vm=headless
REM --post-install-template= shutdown
